...
type Settings struct {
	...
	AutoUpdateIncludeMode          SettingVariable `key:"autoUpdateIncludeMode" meta:"label=Auto Update Include Mode;type=boolean;keywords=include,exclude,containers,invert,mode,allowlist;category=internal;description=Treat the auto-update container list as containers to include instead of exclude"`
	...
	AutoHealIncludeMode            SettingVariable `key:"autoHealIncludeMode" meta:"label=Auto Heal Include Mode;type=boolean;keywords=auto,heal,include,exclude,containers,invert,mode,allowlist;category=internal;description=Treat the auto-heal container list as containers to include instead of exclude"`
