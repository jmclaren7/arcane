...
>
> The full, up-to-date list of changes that set this fork apart from upstream — and the notes for re-applying them when rebasing — lives in **[FORK_CHANGES.md](FORK_CHANGES.md)**. In short, the fork carries a project-name sanitisation fix, a flash-of-incorrect-theme fix, several build/dev-container/line-ending fixes, expanded contributor docs, and CI workflows adapted to run on a fork without upstream-only infrastructure.
>
